...
#     """
#
#     sigCenterChanged = Signal(float)
#     sigCORChanged = Signal(bool)
#     sigROIWidgetChanged = Signal(pg.ROI)
#
...
#         self.imgoverlay_roi.translate(
#             pg.Point((2 * center + 1 - self.data.shape[1] - s, 0)))  # 1 again due to the so-called COR
#         # conventions...
#
